...
class ApplicantaddressesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            ///debug($this->Applicantaddresses->save($applicantaddress));
             //exit;
        ...
        $cities = $this->Applicantaddresses->Cities->find('list', ['limit' => 200]);
       
        $this->set(compact('applicantaddress', 'applicants','cities'));
    }
