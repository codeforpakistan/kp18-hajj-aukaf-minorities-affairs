<div class="tab-pane <?= $education_active ?>" id="education">
            ...
            <table id="qualification_details" class="table table-striped table-bordered table-hover datatable">
                ...
                <tbody>
                    ...
                    if (!empty($applicant->qualifications)) {
                        ...
                        ?> 
                        <tr>
                            <td colspan="6">No Qualification inserted yet</td>
                        </tr>
    ...
    <?= $this->Form->create('Qualifications', ['class' => 'form-horizontal', 'id' => 'education_form', 'style' => 'display:none;']); ?>
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-content">
                <div class="row">
                    <div class="col-sm-12 alert alert-info" style="padding:10px !important;">
                        <!--<i class="icon-remove close" data-dismiss="alert"></i>-->
                        Please enter your qualifications in lowest to highest (Chronological) order.<br/>
                        Please select "Add/Update to List" button after adding information to save the record.
                    </div>
                    <div class="col-md-6">
