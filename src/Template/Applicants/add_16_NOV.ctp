                ...
                <div class="col-md-10">
                    <div class="widget box" id="form_wizard">
                        ...
                        <div class="widget-content">
                            <div class="lang"  id="google_translate_element" style="margin-bottom: 15px;padding: 0 5px;">
                                <?php
                                if ($auth->user('role_id') == 1 || $auth->user('role_id') == 2) {
                                    ?>
                                    <a onclick="window.history.go(-1);
                                            return false;" style ="font-size: 14px;color: green;text-decoration: underline; cursor: pointer;">Go back</a>
                                        ...
                                        <div class="tab-content" style="margin-top:60px">
                                            ...
                                            <div class="tab-pane" id="tab2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <?php
                                                        echo $this->Form->control('ApplicantAttachments.attachments[]', ['id' => 'attachments', 'secure' => false, 'label' => false, 'type' => 'file', 'style' => 'margin:unset', 'multiple' => true]);
                                                        ?>
                                                        <p style="color:red;margin-top: 5px;"><?= $subCategory->description ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /Your Profile -->
