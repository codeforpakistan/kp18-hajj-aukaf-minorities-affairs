                    ...
                    <ul class="list">
                        ...
                        <?php } else { ?>
                            ...
                            <li>
                                ...
                                ?>
                                <a href="javascript:void(0);" class="menu-toggle <?= ($this->request->params['controller'] == 'Applicants' && in_array($this->request->params['action'], $report_array)) ? 'toggled' : ''; ?>">
                                    <i> <img   src="<?php echo $this->request->webroot . 'img/reporting.svg'; ?>" alt=""  width="24px"/></i>
                                    <span class="<?= ($this->request->params['controller'] == 'Applicants' && in_array($this->request->params['action'], $report_array)) ? 'myactive' : ''; ?>">Reporting section</span>
                                </a>
                                <ul class="ml-menu">
                                    ...
                                    if (!empty($showlink)) {
                                        ?>
                                        <li>
                                            <a href="javascript:void(0);" class="menu-toggle <?= ($this->request->params['controller'] == 'Applicants' && in_array($this->request->params['action'], $inst_report_array)) ? 'toggled' : ''; ?>">
                                    ...
                                    ?>
                                    <li><?= $this->Html->link(__('Region/Religion Reporting'), ['controller' => 'Applicants', 'action' => 'region']) ?></li>
                                    <li><?= $this->Html->link(__('Date wise summary '), ['controller' => 'Applicants', 'action' => 'datereporting']) ?></li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle <?= ($this->request->params['action'] == 'distribution' || $this->request->params['action'] == 'balloting' || $this->request->params['action'] == 'distributegrants' || $this->request->params['action'] == 'deselect') ? 'toggled' : ''; ?>">
                                    <i> 
                                        <img   src="<?php echo $this->request->webroot . 'img/grantsphase.svg'; ?>" alt=""  width="24px"/>
                                    </i>
                                    <span  class="<?= ($this->request->params['action'] == 'distribution' || $this->request->params['action'] == 'balloting' || $this->request->params['action'] == 'distributegrants' || $this->request->params['action'] == 'deselect') ? 'myactive' : ''; ?>">Selection phase</span>
                                </a>
                                <ul class="ml-menu">
                                    <li>
                                    ...
                                    <li>
                                        <a style="padding-left: 62px;" href="<?php echo $this->request->webroot; ?>admin/Applicants/deselect">De-select</a>
                                    </li>
                                    <li>
