            ...
            <div class="container-fluid">
                <div class="navbar-header col-lg-12">
                    <div class="col-lg-2 hidden-md hidden-sm hidden-xs" style="padding:0px">
                        <img class="img img-responsive" src="<?php echo $this->request->webroot . 'img/logo2.png'; ?>" alt="User"  height="60"/>
                    </div>
                    <div class="col-lg-8 col-sm-12 col-xs-12 haj_div">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right new">
                            ...
                            <li class="new"><img  style="border-radius:50px;border:2px solid white; " data-close="true" src="<?php echo $this->request->webroot . 'img/applicants/' . $loguser['photo']; ?>" alt="User" width="35" height="35"/>
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                ...
                                <li>
                                    <?= $this->Html->link(__('New Applicants'), '/') ?>
                                </li>
                            </ul>
                        </li>
                        <li>
