...
<div class="qualificationLevels index large-9 medium-8 columns content">
    <h3><?= __('Qualification Levels') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $qualificationLevel->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $qualificationLevel->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $qualificationLevel->id], ['confirm' => __('Are you sure you want to delete # {0}?', $qualificationLevel->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
