...
<div class="degreeAwardings index large-9 medium-8 columns content">
    <h3><?= __('Degree Awardings') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $degreeAwarding->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $degreeAwarding->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $degreeAwarding->id], ['confirm' => __('Are you sure you want to delete # {0}?', $degreeAwarding->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
