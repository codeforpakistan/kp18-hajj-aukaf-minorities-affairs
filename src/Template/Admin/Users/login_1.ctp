...
<link rel="icon" href="<?php echo $this->request->webroot ;?>favicon.ico" type="image/x-icon">
    ...
    <!-- Google Fonts -->
    <link href="<?php echo $this->request->webroot ;?>css/font.css" rel="stylesheet">
    <link href="<?php echo $this->request->webroot ;?>css/icon.css" rel="stylesheet">
            ...
            <div class="body">
                <?= $this->Form->create() ?>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <?php echo $this->Form->input('email',['class'=>'form-control','pattern'=>'[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$','placeholder'=>'Email','label'=>false,'autofocus','required']);?>
