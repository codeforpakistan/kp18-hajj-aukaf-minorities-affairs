                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-line col-lg-3">
                                <br/>
                                <?php echo $this->Form->control('limit', ['placeholder' => "Enter number of people to select", 'class' => 'form-control show-tick show sub_categ', 'label' => false, 'required']); ?>
                            </div>
                        </div>
                        <br/>
                    </div>
...
//                                            debug($result);
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <?php echo $this->Form->checkbox('checkall', ['hiddenField' => false, 'name' => false, 'class' => 'filled-in', 'onchange' => 'count_all()', 'id' => 'checkall']); ?>
