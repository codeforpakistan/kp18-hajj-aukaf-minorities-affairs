    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <h4 style="padding: 15px 15px;">Search for applicant to deselect</h4>
                    <?= $this->Form->create('search') ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-line col-lg-3">
                                <br/>
                                <?php echo $this->Form->control('fund_id', ['empty' => 'Select Funds', 'class' => 'form-control show-tick show sub_categ', 'id' => 'fund_id', 'label' => false, 'options' => @$funds,'required']); ?>
                            </div>
                            <div class="form-line col-lg-3">
                                <br/>
                            ...
                            <div class="form-line col-lg-3">
                                <br/>
                                <?php echo $this->Form->control('cnic', ['placeholder' => 'Search by Token number', 'class' => 'form-control show-tick show sub_categ', 'label' => false]); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
//                                            debug($result);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $cheque_no = ($result['selected'] == 1) ? 'checked' : '';
                                                    echo $this->Form->checkbox('distributed', ['hiddenField' => false, 'class' => 'filled-in', 'id' => 'deselect' . $result['af_id'], 'onchange' => 'deselect(' . $result['af_id'] . ')', $cheque_no]);
                                                    ?>
                                                    <label for="deselect<?php echo $result['af_id']; ?>"></label>
                                                </td>
                                            </tr>
                                            <?php
                                        endforeach;
