...
//                                                    echo $this->Form->checkbox('ApplicantFunddetails.selected[]', ['class' => 'chk-col-green', 'id' => 'selected'.$result['applicant_id'],'value'=>1]);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6" style="background-color: #eee9;padding: 15px 15px !important;">
                                        ...
                                        echo $this->Form->number('amount_recived', ['id' => 'amount_recived', 'class' => 'form-control', 'max' => $remaining_amount/count($results)]);
                                        ?>
...
//                                        echo $this->Form->number('fund_amount', ['id' => 'total_amount', 'class' => 'form-control', 'value' => $remaining_amount, 'max' => $remaining_amount]);
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <p>Total Amount For Fund: <span style="font-weight: bold;"><?= $results[0]['total_amount']; ?></span></p>
                                        <p>All selected Applicants: <span style="font-weight: bold;"><?= $selected_applicants; ?></span></p>  
