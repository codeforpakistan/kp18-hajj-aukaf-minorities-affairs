...
//                                            debug($result);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $cheque_no = ($result['distributed'] == 1) ? 'checked' : '';
                                                    echo $this->Form->checkbox('distributed', ['hiddenField' => false, 'class' => 'filled-in', 'id' => 'cheque_no' . $result['af_id'], 'onchange' => 'update_cheque_no(' . $result['af_id'] . ')', $cheque_no]);
                                                    ?>
                                                    <label for="cheque_no<?php echo $result['af_id']; ?>"></label>
                                                </td>
                                                <td>
                                                    <?php echo ($result['distributed'] == 1) ? 'distributed' : ''; ?>
                                                </td>
                                            </tr>
                                            <?php
                                        endforeach;
