...
<div class="instituteTypes index large-9 medium-8 columns content">
    <h3><?= __('Institute Types') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $instituteType->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $instituteType->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $instituteType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $instituteType->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
