...
$(function () {
    ...
    $('input[type=select][name="Qualification[education_system]"]').on('change', function () {
        $('#recent_class').val('');
        $('#current_class').val('');
        $('#passing_date').val('');
    ...
    if ($('input[type=select][name="Qualification[grading_system]"]').val()) {
        var grading_system = $(this).val();
