                ...
                <div class="col-md-10">
                    <div class="widget box" id="form_wizard">
                        ...
                        <div class="widget-content">
                            ...
                            {!! Form::open(['route' => 'guest.home.index', 'method' => 'POST', 'id' => 'sample_form', 'files' => true, 'class' => 'form-horizontal']) !!}
                            <!--=== Basic Information ===-->
                            <?php
                                if ( ! session('Applicantcnic') ) {
                            ?>
                                <style>
                                    .bg-image{
                                ...
                                <div class="" id="initial" style="margin-top: 25px !important;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::text('fund_id', old('fund_id'), ['id' => 'fund_id', 'label' => false, 'class' => 'form-control', 'empty' => 'Select Grant', 'required']) !!}
